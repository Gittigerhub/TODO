...
import com.muzik.todo.Service.TodoService;
...
import static com.muzik.todo.Util.PaginationUtil.Pagination;
...
public class TodoController {
    ...
    -----------------------------------------------------------------------*/
    @GetMapping("/a")
    // @PageableDefault(page = 1) => 페이지번호가 생략되었을때 기본 1페이지로 설정한다.
    public String aForm(@PageableDefault(page = 1)Pageable pageable, Model model) {
    ...
    -----------------------------------------------------------------------*/
    @GetMapping("/c")
    public String bForm(Integer id, Model model) {
        // 서비스를 통해서 해당 레코드를 조회
